...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_ADR 0xC01F4000U     /* SDRAM after LTDC framebuffer (1280*800*2) */
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER 'N'      /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
